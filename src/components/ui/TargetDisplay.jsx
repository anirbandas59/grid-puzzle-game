...
const TargetDisplay = ({ value, type = 'row' }) => {
  const targetClass =
    type === 'row'
      ...
      : 'w-14 h-14 flex items-center justify-center font-bold text-blue-900 mb-2 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl border-2 border-blue-300 shadow-md';
